...
def rslt_saving(rslt_dir, model, Df, data, m_kwargs_a, m_kwargs_b, sample_T,
    ...
    plt.figure(figsize=(4, 4))
    plot_2_mice(sample_x, title="sample", xlim=[ARENA_XMIN-20, ARENA_XMAX+20], ylim=[ARENA_YMIN-20, ARENA_YMAX+20])
    plt.legend()
