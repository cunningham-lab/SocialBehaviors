...
observation = DirectionObservation(K=K, D=D, Df=Df, bounds=bounds, momentum_lags=momentum_lags,
                                   momentum_weights=momentum_weights, feature_vec_funcs=feature_vec_func)
...
features = DirectionTransformation._compute_features(feature_funcs=feature_vec_func, inputs=data[:-1])
