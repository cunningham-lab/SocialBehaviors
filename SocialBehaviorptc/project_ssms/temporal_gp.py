...
class TemporalGPObservation(BaseObservation):
    def __init__(self, K, D, M=0, lags=10, bounds=None, transformation="grid",
                 transformation_kwargs=None, train_sigma=True, device=torch.device('cpu')):

        super(TemporalGPObservation, self).__init__(K, D, M)
