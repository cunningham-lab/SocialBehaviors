...
class GPObservationSingleNonlinear(BaseObservation):
    """
    ...
    """
    def __init__(self, K, D, Df, x_grids, y_grids, bounds, feature_vec_func, acc_factor=20, mus_init=None,
                rs=None, train_rs=False, train_vs=False,
                 device=torch.device('cpu')):
        assert D == 2
        super(GPObservationSingleNonlinear, self).__init__(K, D)
